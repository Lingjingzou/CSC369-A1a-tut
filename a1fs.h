...
typedef struct a1fs_superblock {
	...
	unsigned int   s_first_ino;         /* First inode */
	unsigned short s_inode_size;        /* inode size*/
...
typedef struct a1fs_inode {
	...
	//TODO: add necessary fields
	unsigned int   i_blocks;    /* block counts in disk sector */
	unsigned int   i_block[15]; /** pointer to blocks*/
	char 	padding[32];
